"""PostgreSQL storage — reuses core models and adds console-specific tables."""
...
# ─── Core models (mirrored for read access) ────────────────────────────────
...
class Alert(Base):
    """Materialized alert instances triggered by alert rules."""

    __tablename__ = "console_alerts"
