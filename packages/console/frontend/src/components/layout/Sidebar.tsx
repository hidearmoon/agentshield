...
export function Sidebar() {
  return (
    <aside className="flex w-60 flex-col border-r border-sidebar-border bg-sidebar-bg">
      {/* Logo */}
      ...
      <div className="border-t border-sidebar-border p-4">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-surface-overlay text-xs font-medium text-gray-300">
            AS
          </div>
