...
from agentshield_core.api.v1.router import v1_router
from agentshield_core.dependencies import get_pipeline
from agentshield_core.engine.pipeline import Pipeline
from agentshield_core.storage.postgres import init_db, close_db
from agentshield_core.storage.clickhouse import init_clickhouse, close_clickhouse
...
def create_app() -> FastAPI:
    ...
    async def health_detailed() -> dict:
        ...
        try:
            from agentshield_core.storage.clickhouse import get_clickhouse
